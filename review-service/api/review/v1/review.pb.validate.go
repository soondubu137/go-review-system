...
func (m *CreateReviewRequest) validate(all bool) error {
	...
	if _, ok := _CreateReviewRequest_ServiceRating_InLookup[m.GetServiceRating()]; !ok {
		err := CreateReviewRequestValidationError{
			field:  "ServiceRating",
			reason: "value must be in list [1 2 3 4 5]",
		}
	...
	if _, ok := _CreateReviewRequest_DeliveryRating_InLookup[m.GetDeliveryRating()]; !ok {
		err := CreateReviewRequestValidationError{
...
var _CreateReviewRequest_Rating_InLookup = map[int32]struct{}{
	1: {},
	2: {},
	3: {},
	4: {},
...
var _CreateReviewRequest_ServiceRating_InLookup = map[int32]struct{}{
	1: {},
	2: {},
	3: {},
	4: {},
...
var _CreateReviewRequest_DeliveryRating_InLookup = map[int32]struct{}{
	1: {},
	2: {},
	3: {},
	4: {},
