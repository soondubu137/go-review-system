CREATE TABLE reviews (
    ...
    `pictures` JSON NOT NULL DEFAULT '[]' COMMENT 'Review pictures',
    `videos` JSON NOT NULL DEFAULT '[]' COMMENT 'Review videos',
    ...
    `tags` JSON NOT NULL DEFAULT '[]' COMMENT 'Related tags',
    ...
    `snapshot` JSON NOT NULL DEFAULT '{}' COMMENT 'Snapshot of the review',
